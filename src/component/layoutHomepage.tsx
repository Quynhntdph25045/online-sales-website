            ...
            {!user && (
              <><button className='px-10 dropdown relative hover:text-blue-500 outline-none' onClick={handleClick}><BsPersonCircle size={35} /></button>
                {dropDown ?
                  ...
                  <li> <a href="/signin" className='block py-2 font-bold border-b-2 hover:bg-red-300 hover:text-white'>Signin</a></li>
                  <li><a href="/signup" className='block py-2 font-bold hover:bg-red-300 hover:text-white'>Signup</a></li>
                </ul>
                  : ""
                }
              </>
